...
The data was scaled previously which also accomplishes mean-centering, so we do not need to specify additional parameters in the prcomp() function to scale or center again. 
```{r}
