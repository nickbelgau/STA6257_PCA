...
self-contained: true
engine:
  python: "C:/Users/Belgau/AppData/Local/Programs/Python/Python310/python.exe"
execute: 
  warning: false
  message: false
editor: 
...
Images were flattened from 32x32x3 to 1-dimensional vectors for PCA, resulting in 3072 features per image.
...
Two SVM models were trained: one on the original flattened data and one on the PCA-transformed data.
Accuracy on the test set for SVM on original data was 0.336, and on PCA-transformed data, it was 0.313.
