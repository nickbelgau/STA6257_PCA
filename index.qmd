...
```{r}
url <- "https://raw.githubusercontent.com/nickbelgau/STA6257_PCA/main/data/Alz_mortality_data_complete_with_state_csv%20-%20Copy.csv"
...
```{r}
selected_columns <- c(
  "County", "State", "mental_distress", "obesity_age_adj", "Smoking_Rate", "physical_inactivity", "Diabetes", "Heart_Disease", "Cancer", "NATA_Cancer_11", "Glyphosates", "Fine_PM_2_5", "Mercury_TPY", "Lead_TPY", "per_rural", "Food_index", "Poverty_Percent", "Atrazine_High_KG", "SUNLIGHT"
)
